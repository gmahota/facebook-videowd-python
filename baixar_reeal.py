# Criando o arquivo baixar_video.py com o código atualizado para baixar vídeos do Facebook
baixar_video_code = ""
import sys
import yt_dlp
...
# Salvando o conteúdo no arquivo baixar_video.py
with open("/mnt/data/baixar_video.py", "w") as file:
    file.write(baixar_video_code)

"/mnt/data/baixar_video.py"
